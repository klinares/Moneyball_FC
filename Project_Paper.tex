...
misestimates the true drivers of market value in this volatile era.\\
\strut \\
To address these limitations, this study applies a cross-classified
...
this structural break. By disentangling individual reputation from club
context, we investigate four critical dynamics: the non-linear ``Boom
and Bust'' market trajectory (RQ1)\footnote{How has the transfer market
  evolved relative to the 2020 baseline? Specifically, does the market
  exhibit a non-linear ``Boom and Bust'' cycle that linear models miss?},
the biological constraints of the player career arc (RQ2)\footnote{How
  does market valuation evolve across a player's biological career, and
  at what specific age does this value peak?}, the valuation signal of
``Squad Status'' via relative playing time (RQ3)\footnote{To what degree
  does ``Squad Status''---defined by relative playing time---predict
  market value independent of raw performance output?}, and the
existence of contextual premiums for club diversity or discounts for
domestic talent in a globalized labor market
(RQ4\footnote{How is club-level international diversity associated with
  player valuations in a globalized labor market?}-RQ5\footnote{How does
  the market valuation of domestic players compare to that of imported
  talent when controlling for performance and club context?}).

\section{Method}\label{method}

\subsection{Sample and Variables}\label{sample-and-variables}
...
clubs or remain in the same club throughout their career.

\pandocbounded{\includegraphics[keepaspectratio]{Project_Paper_files/figure-pdf/unnamed-chunk-1-1.pdf}}

\subsection{Model Specification}\label{model-specification}

We specify a cross-classified multilevel model to partition the variance
in market value across observations (\(t\)), players (\(i\)), and clubs
(\(j\)). Crucially, because club attributes like internationalization
and UEFA ranking vary year-to-year, they are modeled as Level 1
(time-varying) predictors rather than static Level 2 traits.
...
\pandocbounded{\includegraphics[keepaspectratio]{Project_Paper_files/figure-pdf/unnamed-chunk-2-1.pdf}}
...
All analyses were conducted in R version 4.5.1 using the
...
\pandocbounded{\includegraphics[keepaspectratio]{Project_Paper_files/figure-pdf/unnamed-chunk-5-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Project_Paper_files/figure-pdf/unnamed-chunk-7-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Project_Paper_files/figure-pdf/unnamed-chunk-8-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Project_Paper_files/figure-pdf/unnamed-chunk-12-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Project_Paper_files/figure-pdf/unnamed-chunk-13-1.pdf}}
