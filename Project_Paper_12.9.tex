...
causing an estimated €8.7 billion revenue shortfall (Deloitte, 2021).
Using Transfermarkt estimates as validated proxies for transfer fees
(Herm et al., 2014), we fit a cross-classified multilevel model to
account for players transferring between clubs. We address this gap by
fitting a cross-classified multilevel model to a decade of data
(2013--2024), centering at the 2020 baseline to isolate pandemic impacts
while accounting for player movements across clubs. Specifically, we
...
\pandocbounded{\includegraphics[keepaspectratio]{Project_Paper_12.9_files/figure-pdf/unnamed-chunk-1-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Project_Paper_12.9_files/figure-pdf/unnamed-chunk-2-1.pdf}}
...
slopes model). Model comparisons are shown in Appendix C, Table 1. Our
final model converged successfully and model diagnostic plots (see
Appendix C, Figure 1) confirmed normality of random effects and
homoscedastic residuals, along with the correlation structure captured
in Appendix C, Figure 2.

\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-3}Estimated Variance Components for Final Model}
\centering
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-3}Fixed Effects Estimates from Final Model}
\centering
...
more resilient recovery, indicating a more resilient recovery and active
value generation throughout the decade.

\pandocbounded{\includegraphics[keepaspectratio]{Project_Paper_12.9_files/figure-pdf/unnamed-chunk-4-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Project_Paper_12.9_files/figure-pdf/unnamed-chunk-6-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Project_Paper_12.9_files/figure-pdf/unnamed-chunk-7-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Project_Paper_12.9_files/figure-pdf/unnamed-chunk-11-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Project_Paper_12.9_files/figure-pdf/unnamed-chunk-12-1.pdf}}
...
with higher baseline prestige experienced slower subsequent growth i.e.,
a regression-to-the-mean pattern where elite clubs had less room for
