...
The correlation between club intercept and linear slope was weak and
non-significant (r = -0.06), suggesting minimal regression-to-the-mean.
The positive correlation between linear and quadratic slopes (r = 0.75)
indicates that clubs with faster initial growth experienced more
pronounced curvature around the pandemic period.
