...
\
To address these limitations, this study applies a cross-classified multilevel model to a decade of transfer data (2013–2024), centering the analysis at the 2020 pandemic baseline to quantify the impact of this structural break. This approach disentangles individual reputation from club context, allowing us to investigate four critical dynamics: the non-linear "Boom and Bust" market trajectory (RQ1)[^1], the biological constraints of the player career arc (RQ2)[^2], the valuation signal of "Squad Status" via relative playing time (RQ3)[^3], and the existence of contextual premiums for club diversity or discounts for domestic talent in a globalized labor market (RQ4[^4]-RQ5[^5]).
...
ggplot(final_plot_data, aes(x = x + 2020, y = predicted)) +
  ...
  labs(
    ...
    subtitle = "Dashed line marks pandemic onset; panels ordered by baseline prestige.",
    x = "Season Year",
