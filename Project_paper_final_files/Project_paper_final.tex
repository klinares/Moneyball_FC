...
\subsubsection{Sample and Data}\label{sample-and-data}
...
\includegraphics{Project_paper_final_files/figure-pdf/unnamed-chunk-1-1.pdf}
...
\includegraphics{Project_paper_final_files/figure-pdf/unnamed-chunk-2-1.pdf}

\subsubsection{Model Testing and Statistical
...
All analyses were conducted in R version 4.5.2 using the
...
\includegraphics{Project_paper_final_files/figure-pdf/unnamed-chunk-4-1.pdf}
...
\includegraphics{Project_paper_final_files/figure-pdf/unnamed-chunk-6-1.pdf}
...
facing the steepest positional penalty \(\beta_{pos,2}=-1.06\). Latin
America shows a significant premium \(\beta_{reg, 2}=.19\) suggesting
South American players function as a ``premium export brand'' in the
global market.

\includegraphics{Project_paper_final_files/figure-pdf/unnamed-chunk-7-1.pdf}
...
\includegraphics{Project_paper_final_files/figure-pdf/unnamed-chunk-11-1.pdf}
...
\includegraphics{Project_paper_final_files/figure-pdf/unnamed-chunk-12-1.pdf}
